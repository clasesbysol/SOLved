(function(){
  ...
  const DB_VERSION=7;
  const STORES=["kv","subjects","events","highlights","cardProgress","exerciseProgress","syncQueue","meta","contentPackages","importedHtml","notes","studySessions","collections","bookmarks","activityLog"];
