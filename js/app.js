(function(){
  ...
  async function renderStudy(){
    ...
    const cardsTab=els.studyTabs.querySelector('[data-tab="cards"]');if(cardsTab)cardsTab.hidden=s.id==="fisica1";if(s.id==="fisica1"&&currentTab==="cards"){currentTab="summary";settings.lastTab="summary";els.studyTabs.querySelectorAll(".tab").forEach(tab=>tab.classList.toggle("active",tab.dataset.tab==="summary"))}
