(function(){
  ...
  const els={
    pageTitle:$("pageTitle"),crumb:$("crumb"),globalSearch:$("globalSearch"),backupBtn:$("backupBtn"),themeBtn:$("themeBtn"),appearancePanel:$("appearancePanel"),visualTheme:$("visualTheme"),appearanceClose:$("appearanceClose"),resetAppearance:$("resetAppearance"),restoreInput:$("restoreInput"),
  ...
  async function exportBackup(){const payload=await DB.exportAll(),blob=new Blob([JSON.stringify(payload,null,2)],{type:"application/json"}),a=document.createElement("a");a.href=URL.createObjectURL(blob);a.download=`biblioteca-lbt-respaldo-v052-${new Date().toISOString().slice(0,10)}.json`;a.click();setTimeout(()=>URL.revokeObjectURL(a.href),1000);toast("Respaldo completo exportado")}
