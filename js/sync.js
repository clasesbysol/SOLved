(function(root,factory){
  ...
  const SETTINGS_FIELDS=["theme","currentIds","order","calendar","lastPage","lastSubject","lastTab","lastBlock","lastUnitBySubject","zoomIndex","viewerVisible","indexVisible","readingGlobal","readingBySubject"];
