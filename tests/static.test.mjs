...
assert.ok(index.includes("js/study-workspace.js?v=0.11.10")&&sw.includes("./js/study-workspace.js?v=0.11.10"),"el workspace debe estar disponible offline");
...
assert.equal(JSON.parse(await readFile("version.json", "utf8")).appVersion, "0.11.10");
assert.ok(index.includes("v0.11.10"), "La versión visible debe ser 0.11.10");
