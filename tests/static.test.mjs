...
assert.ok(index.includes("js/study-workspace.js?v=0.11.8")&&sw.includes("./js/study-workspace.js?v=0.11.8"),"el workspace debe estar disponible offline");
...
assert.equal(JSON.parse(await readFile("version.json", "utf8")).appVersion, "0.11.8");
assert.ok(index.includes("v0.11.8"), "La versión visible debe ser 0.11.8");
