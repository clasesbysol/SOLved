...
for (const ref of ["styles.css?v=0.6.2", "manifest.webmanifest", "js/data.js?v=0.6.2", "js/db.js?v=0.6.2", "js/sync.js?v=0.6.2", "js/content.js?v=0.6.2", "js/notes.js?v=0.6.2", "js/utilities.js?v=0.6.2", "js/summary-factory.js?v=0.6.2", "js/app.js?v=0.6.2"]) {
...
for (const ref of ["./index.html", "./styles.css?v=0.6.2", "./js/sync.js?v=0.6.2", "./js/content.js?v=0.6.2", "./js/notes.js?v=0.6.2", "./js/utilities.js?v=0.6.2", "./js/summary-factory.js?v=0.6.2", "./js/app.js?v=0.6.2", "./privacy.html", "./terms.html"]) {
...
assert.equal(JSON.parse(await readFile("version.json", "utf8")).appVersion, "0.6.2");
assert.ok(index.includes("v0.6.2"), "La versión visible debe ser 0.6.2");
