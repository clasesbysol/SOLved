...
assert.equal(JSON.parse(await readFile("version.json", "utf8")).appVersion, "0.11.5");
assert.ok(index.includes("v0.11.5"), "La versión visible debe ser 0.11.5");
