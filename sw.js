...
const CACHE_VERSION = "biblioteca-lbt-v0110-qbi4-10-stats130-integral";
const CORE = [
  "./","./index.html","./bienvenida.html",
  "./styles.css?v=0.10.9","./styles-enhancements.css?v=0.10.9","./styles-personal.css?v=0.10.9",
  "./organic-cards.css?v=0.7.3","./organic-mind-map.css?v=0.7.3",
  "./js/supabase-config.js?v=0.8.0","./js/auth.js?v=0.8.1","./js/data.js?v=0.10.10","./js/db.js?v=0.10.9","./js/supabase-sync.js?v=0.10.9",
  "./js/organic-cards.js?v=0.7.3","./js/organic-mind-map.js?v=0.10.9","./js/sync.js?v=0.10.9","./js/content.js?v=0.10.11","./js/study-workspace.js?v=0.10.10","./js/notes.js?v=0.7.3","./js/utilities.js?v=0.10.9","./js/summary-factory.js?v=0.7.3","./js/career-factory.js?v=0.7.3","./js/app.js?v=0.10.10",
  ...
  "./js/estadistica-integral-bridge.js?v=1.3.0","./js/solved-update-status.js?v=1.0.0",
  "./content/catalog.json",
  "./content/subjects/estadistica/units/probabilidad-practica-1/estadistica-integral.html?v=1.3.0",
  "./content/subjects/estadistica/units/probabilidad-practica-1/theory.html?v=1.3.0",
  "./content/subjects/estadistica/units/probabilidad-practica-1/exercises.json?v=1.3.0",
  "./content/subjects/estadistica/units/probabilidad-practica-1/glossary.json?v=1.3.0",
  "./content/subjects/estadistica/units/probabilidad-practica-1/estadistica-practica1-prompts-v130.json?v=1.3.0",
  "./content/subjects/estadistica/units/probabilidad-practica-1/estadistica-practica2-v120-a.json?v=1.3.0",
  "./content/subjects/estadistica/units/probabilidad-practica-1/estadistica-practica2-v120-b.json?v=1.3.0",
  "./content/subjects/estadistica/units/probabilidad-practica-1/estadistica-source-prompts-v130.json?v=1.3.0",
  "./content/subjects/estadistica/units/probabilidad-practica-1/estadistica-va-extension.html?v=1.3.0",
  "./content/subjects/estadistica/units/probabilidad-practica-1/estadistica-lab-24-08.html?v=1.3.0",
  "./content/subjects/estadistica/units/probabilidad-practica-1/estadistica-campus-exercises.html?v=1.3.0",
