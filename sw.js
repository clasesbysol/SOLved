...
const CACHE_VERSION = "biblioteca-lbt-v01122-developer-comments";
const CORE = [
  ...
  "./js/subject-skeleton.js?v=0.1.0","./js/integral-frame-tools.js?v=1.0.0","./js/persistence-repair.js?v=1.0.0","./js/reading-mode-v2.js?v=1.1.0","./js/qbi-official-frame-fix.js?v=1.3.0","./js/fisica-first-partial-guide.js?v=1.1.0","./js/fisica-topic-intros.js?v=1.2.0",
  "./js/estadistica-integral-bridge.js?v=1.4.0","./js/solved-update-status.js?v=1.1.0","./js/study-chrome.js?v=0.11.17","./js/analysis2-integrated.js?v=1.0.0","./js/developer-comments.js?v=1.0.0",
