...
const CACHE_VERSION = "biblioteca-lbt-v064-1";
const CORE = [
  "./",
  "./index.html",
  "./styles.css?v=0.6.4",
  "./styles-enhancements.css?v=0.6.4",
  "./js/authorized-users.js?v=0.6.4",
  "./js/auth.js?v=0.6.4",
  "./js/data.js?v=0.6.4",
  "./js/db.js?v=0.6.4",
  "./js/sync.js?v=0.6.4",
  "./js/content.js?v=0.6.4",
  "./js/notes.js?v=0.6.4",
  "./js/utilities.js?v=0.6.4",
  "./js/summary-factory.js?v=0.6.4",
  "./js/career-factory.js?v=0.6.4",
  "./js/app.js?v=0.6.4",
