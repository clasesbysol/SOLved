...
const CACHE_VERSION = "biblioteca-lbt-v060-1";
const CORE = [
  "./",
  "./index.html",
  "./styles.css?v=0.6.0",
  "./js/authorized-users.js?v=0.6.0",
  "./js/auth.js?v=0.6.0",
  "./js/data.js?v=0.6.0",
  "./js/db.js?v=0.6.0",
  "./js/sync.js?v=0.6.0",
  "./js/content.js?v=0.6.0",
  "./js/notes.js?v=0.6.0",
  "./js/utilities.js?v=0.6.0",
  "./js/summary-factory.js?v=0.6.0",
  "./js/career-factory.js?v=0.6.0",
  "./js/app.js?v=0.6.0",
