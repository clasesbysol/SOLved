...
const CACHE_VERSION = "biblioteca-lbt-v01121-version-status";
const CORE = [
  ...
  "./js/estadistica-integral-bridge.js?v=1.4.0","./js/solved-update-status.js?v=1.1.0","./js/study-chrome.js?v=0.11.17","./js/analysis2-integrated.js?v=1.0.0",
