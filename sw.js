...
const CACHE_VERSION = "biblioteca-lbt-v01117-subject-skeleton-v2";
const CORE = [
  ...
  "./js/subject-skeleton.js?v=0.1.0","./js/reading-mode-v2.js?v=1.1.0","./js/qbi-official-frame-fix.js?v=1.0.0","./js/fisica-first-partial-guide.js?v=1.1.0","./js/fisica-topic-intros.js?v=1.2.0",
