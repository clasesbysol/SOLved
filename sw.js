...
const CACHE_VERSION = "biblioteca-lbt-v062-1";
const CORE = [
  "./",
  "./index.html",
  "./styles.css?v=0.6.2",
  "./styles-enhancements.css?v=0.6.2",
  "./js/authorized-users.js?v=0.6.2",
  "./js/auth.js?v=0.6.2",
  "./js/data.js?v=0.6.2",
  "./js/db.js?v=0.6.2",
  "./js/sync.js?v=0.6.2",
  "./js/content.js?v=0.6.2",
  "./js/notes.js?v=0.6.2",
  "./js/utilities.js?v=0.6.2",
  "./js/summary-factory.js?v=0.6.2",
  "./js/career-factory.js?v=0.6.2",
  "./js/app.js?v=0.6.2",
