...
const CACHE_VERSION = "biblioteca-lbt-v0121-integrated-subjects";
const CORE = [
  "./","./index.html","./bienvenida.html",
  "./styles.css?v=0.11.0","./styles-enhancements.css?v=0.12.0","./styles-personal.css?v=0.10.9",
  ...
  "./js/organic-cards.js?v=0.7.3","./js/qbi-mind-map-data.js?v=1.1.0","./js/qbi-mind-map-data.js?v=4.4.0","./js/organic-mind-map.js?v=0.11.1","./js/integrated-subject-shell.js?v=1.0.0","./js/sync.js?v=0.11.0","./js/content.js?v=0.11.7","./js/study-workspace.js?v=0.10.10","./js/notes.js?v=0.7.3","./js/utilities.js?v=0.11.0","./js/app.js?v=0.12.0",
  ...
  "./content/subjects/fisica1/units/resumen-integral/integrated.html?v=1.4.0",
  "./content/subjects/quimica_organica/units/resumen-integral/integrated.html?v=0.7.0",
  "./content/subjects/estadistica/units/probabilidad-practica-1/integrated.html?v=1.5.0",
  "./content/subjects/analisis2/units/materia-integrada/integrated.html?v=1.0.0",
  "./content/subjects/fisica1/units/resumen-integral/summary.html?v=1.4.0",
  "./content/subjects/fisica1/units/resumen-integral/exercises.html?v=1.4.0",
  "./content/subjects/fisica1/units/resumen-integral/original.html?v=1.4.0",
  "./content/subjects/fisica1/units/resumen-integral/map.json?v=1.4.0",
  "./content/subjects/fisica1/units/resumen-integral/glossary.json?v=1.4.0",
  "./content/subjects/quimica_organica/units/resumen-integral/original.html?v=0.7.0",
  "./content/subjects/quimica_organica/units/resumen-integral/organic-mind-map.json?v=0.7.0",
  "./content/subjects/quimica_organica/units/resumen-integral/organic-cards-v2.json?v=0.7.0",
  "./content/subjects/quimica_organica/units/resumen-integral/exercises.json?v=0.7.0",
  "./content/subjects/quimica_organica/units/resumen-integral/glossary.json?v=0.7.0",
