...
const CACHE_VERSION = "biblioteca-lbt-v063-1";
const CORE = [
  "./",
  "./index.html",
  "./styles.css?v=0.6.3",
  "./styles-enhancements.css?v=0.6.3",
  "./js/authorized-users.js?v=0.6.3",
  "./js/auth.js?v=0.6.3",
  "./js/data.js?v=0.6.3",
  "./js/db.js?v=0.6.3",
  "./js/sync.js?v=0.6.3",
  "./js/content.js?v=0.6.3",
  "./js/notes.js?v=0.6.3",
  "./js/utilities.js?v=0.6.3",
  "./js/summary-factory.js?v=0.6.3",
  "./js/career-factory.js?v=0.6.3",
  "./js/app.js?v=0.6.3",
