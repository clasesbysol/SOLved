...
const CACHE_VERSION = "biblioteca-lbt-v01118-qbi-glucidos-v1";
const CORE = [
  ...
  "./js/organic-cards.js?v=0.7.3","./js/qbi-mind-map-data.js?v=1.1.0","./js/qbi-mind-map-data.js?v=4.4.0","./js/organic-mind-map.js?v=0.11.1","./js/sync.js?v=0.11.0","./js/content.js?v=0.11.7","./js/study-workspace.js?v=0.11.16","./js/notes.js?v=0.7.3","./js/utilities.js?v=0.11.0","./js/app.js?v=0.11.16",
  "./js/subject-skeleton.js?v=0.1.0","./js/integral-frame-tools.js?v=1.0.0","./js/persistence-repair.js?v=1.0.0","./js/reading-mode-v2.js?v=1.1.0","./js/qbi-official-frame-fix.js?v=1.0.0","./js/fisica-first-partial-guide.js?v=1.1.0","./js/fisica-topic-intros.js?v=1.2.0",
  "./js/estadistica-integral-bridge.js?v=1.4.0","./js/solved-update-status.js?v=1.0.0","./js/study-chrome.js?v=0.11.17","./js/analysis2-integrated.js?v=1.0.0",
  ...
  "./content/subjects/estadistica/units/probabilidad-practica-1/estadistica-integral.html?v=1.4.1",
  ...
  "./content/subjects/quimica_biologica1/units/proteinas-i/original.html?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-integrated-subject.js?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-math-render-fix.js?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-guide-memory-maps.js?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-guide-memory-maps-addon.js?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-guide-memory-maps-more.js?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-guide-memory-equations.js?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-enzimas3-integration.js?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-enzimas3-exercise-figures-addon.js?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-tp2-extension.js?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-glucidos-integration.js?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-glucidos-force-463.js?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-glucidos-summary-1.txt?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-glucidos-summary-2.txt?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-glucidos-summary-3.txt?v=4.6.3",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-glucidos-summary-4.txt?v=4.6.3",
...
async function injectAppShell(request,fallbackUrl){const response=await cacheFirstAndRefresh(request,fallbackUrl);if(!response||!response.ok)return response||Response.error();let text=await response.text();const injections=[];if(!text.includes('data-solved-reading-v2="1"'))injections.push('<script src="./js/reading-mode-v2.js?v=1.1.0" data-solved-reading-v2="1"></script>');if(!text.includes('data-solved-qbi-frame-fix="1"'))injections.push('<script src="./js/qbi-official-frame-fix.js?v=1.0.0" data-solved-qbi-frame-fix="1"></script>');if(!text.includes('data-solved-integral-frame-tools="1"'))injections.push('<script src="./js/integral-frame-tools.js?v=1.0.0" data-solved-integral-frame-tools="1"></script>');if(!text.includes('data-solved-persistence-repair="1"'))injections.push('<script src="./js/persistence-repair.js?v=1.0.0" data-solved-persistence-repair="1"></script>');if(!text.includes('data-solved-estadistica-integral="1"'))injections.push('<script src="./js/estadistica-integral-bridge.js?v=1.4.0" data-solved-estadistica-integral="1"></script>');if(!text.includes('data-solved-update-status="1"'))injections.push('<script src="./js/solved-update-status.js?v=1.0.0" data-solved-update-status="1"></script>');if(!text.includes('data-solved-study-chrome="1"'))injections.push('<script src="./js/study-chrome.js?v=0.11.17" data-solved-study-chrome="1"></script>');if(!text.includes('data-solved-analysis2-integrated="1"'))injections.push('<script src="./js/analysis2-integrated.js?v=1.0.0" data-solved-analysis2-integrated="1"></script>');if(injections.length)text=text.replace(/<\/body>/i,`${injections.join("")}</body>`);const headers=new Headers(response.headers);headers.delete("content-length");headers.delete("content-encoding");headers.set("content-type","text/html; charset=utf-8");return new Response(text,{status:response.status,statusText:response.statusText,headers})}
self.addEventListener("fetch",event=>{const request=event.request;if(request.method!=="GET")return;const url=new URL(request.url);if(url.origin!==self.location.origin)return;if(request.mode==="navigate"){const internalDocument=url.pathname.includes("/content/")||/\.(?:html?|pdf)$/i.test(url.pathname);event.respondWith(internalDocument?cacheFirstAndRefresh(request):injectAppShell(request,"./index.html"));return}if(url.pathname.endsWith("/content/catalog.json")){event.respondWith(fetch(request,{cache:"no-store"}));return}if(url.pathname.endsWith("/content/subjects/fisica1/units/resumen-integral/original.html")){event.respondWith(injectFisicaGuides(request));return}if(["script","style","worker"].includes(request.destination)){event.respondWith(cacheFirstAndRefresh(request));return}event.respondWith(staleWhileRevalidate(request))});
