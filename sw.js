...
const CACHE_VERSION = "biblioteca-lbt-v090-1";
const CORE = [
  "./",
  "./index.html",
  "./styles.css?v=0.9.0",
  "./styles-enhancements.css?v=0.9.0",
  ...
  "./js/data.js?v=0.9.0",
  "./js/db.js?v=0.9.0",
  "./js/supabase-sync.js?v=0.9.0",
  "./js/organic-cards.js?v=0.7.3",
  "./js/organic-mind-map.js?v=0.7.3",
  "./js/sync.js?v=0.7.3",
  "./js/content.js?v=0.8.1",
  "./js/study-workspace.js?v=0.9.0",
  "./js/notes.js?v=0.7.3",
  "./js/utilities.js?v=0.9.0",
