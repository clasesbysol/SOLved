...
const CACHE_VERSION = "biblioteca-lbt-v01124-organica-html-original";
const CORE = [
  "./","./index.html","./bienvenida.html",
  "./styles.css?v=0.11.1","./styles-enhancements.css?v=0.11.16","./styles-personal.css?v=0.10.9",
  ...
  "./js/organic-cards.js?v=0.7.3","./js/qbi-mind-map-data.js?v=1.1.0","./js/qbi-mind-map-data.js?v=4.4.0","./js/organic-mind-map.js?v=0.11.1","./js/sync.js?v=0.11.0","./js/content.js?v=0.11.8","./js/study-workspace.js?v=0.11.16","./js/notes.js?v=0.7.3","./js/utilities.js?v=0.11.0","./js/app.js?v=0.11.17",
