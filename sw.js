...
const CACHE_VERSION = "biblioteca-lbt-v01112-retire-physics-partials-material";
const CORE = [
  "./","./index.html","./bienvenida.html",
  "./styles.css?v=0.11.0","./styles-enhancements.css?v=0.11.12","./styles-personal.css?v=0.10.9",
  "./organic-cards.css?v=0.7.3","./organic-mind-map.css?v=0.7.4",
  "./js/supabase-config.js?v=0.8.0","./js/auth.js?v=0.8.1","./js/data.js?v=0.11.12","./js/db.js?v=0.10.9","./js/supabase-sync.js?v=0.10.9",
  "./js/organic-cards.js?v=0.7.3","./js/qbi-mind-map-data.js?v=1.1.0","./js/qbi-mind-map-data.js?v=4.4.0","./js/organic-mind-map.js?v=0.11.1","./js/sync.js?v=0.11.0","./js/content.js?v=0.11.7","./js/study-workspace.js?v=0.11.12","./js/notes.js?v=0.7.3","./js/utilities.js?v=0.11.0","./js/app.js?v=0.11.12",
