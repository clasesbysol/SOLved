...
const CACHE_VERSION = "biblioteca-lbt-v0102-1";
const CORE = [
  "./",
  "./index.html",
  "./bienvenida.html",
  "./styles.css?v=0.10.2",
  "./styles-enhancements.css?v=0.10.2",
  "./styles-personal.css?v=0.10.2",
  ...
  "./js/data.js?v=0.10.2",
  "./js/db.js?v=0.10.2",
  "./js/supabase-sync.js?v=0.10.2",
  "./js/organic-cards.js?v=0.7.3",
  "./js/organic-mind-map.js?v=0.7.3",
  "./js/sync.js?v=0.7.3",
  "./js/content.js?v=0.8.4",
  "./js/study-workspace.js?v=0.10.2",
  "./js/notes.js?v=0.7.3",
  "./js/utilities.js?v=0.10.2",
