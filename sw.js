...
const CACHE_VERSION = "biblioteca-lbt-v0113-qbi-map-deep";
const CORE = [
  ...
  "./js/organic-cards.js?v=0.7.3","./js/qbi-mind-map-data.js?v=1.0.0","./js/organic-mind-map.js?v=0.11.0","./js/sync.js?v=0.11.0","./js/content.js?v=0.10.11","./js/study-workspace.js?v=0.10.10","./js/notes.js?v=0.7.3","./js/utilities.js?v=0.11.0","./js/app.js?v=0.11.1",
