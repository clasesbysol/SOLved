...
const CORE = [
  ...
  "./content/subjects/quimica_biologica1/units/proteinas-i/original.html?v=3.4.0",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qbi-enzymes-extension.js?v=3.4.0",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qb3-payload-1.txt?v=3.4.0",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qb3-payload-2.txt?v=3.4.0",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qb3-payload-3.txt?v=3.4.0",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qb3-payload-4.txt?v=3.4.0",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qb3-payload-5.txt?v=3.4.0",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qb3-payload-6.txt?v=3.4.0",
  "./content/subjects/quimica_biologica1/units/proteinas-i/qb3-payload-7.txt?v=3.4.0",
  "./content/subjects/quimica_biologica1/units/proteinas-i/concept-glossary-1.txt?v=3.4.0",
  "./content/subjects/quimica_biologica1/units/proteinas-i/concept-glossary-2.txt?v=3.4.0",
  "./content/subjects/quimica_biologica1/units/proteinas-i/concept-glossary-3.txt?v=3.4.0",
